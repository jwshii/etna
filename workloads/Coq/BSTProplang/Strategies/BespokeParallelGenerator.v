...
Definition timedRunLoop (max_time : nat)  (cprop : CProp ∅): G TimedResult := 
	...
	if  max_time <=? (timePassed start_time current_time) then
		...
		| S fuel' => 
			...
			| Normal _ true =>
				(* Passes *)
				parLoop' fuel' cprop (passed + 1)%nat discards
			| Discard _ _ => 
				(* Discard *)
				parLoop' fuel' cprop passed (discards + 1)%nat
			end
		end in
		parLoop' number_of_trials cprop 0%nat 0%nat
    .
...
(* Definition preciseRunLoop (fuel: nat)  (cprop : CProp ∅): G PreciseResult := 
	...
	let current_time := getCurrentTime tt in
		...
		parLoop' fuel cprop 0%nat 0%nat
	.
...
Definition test_prop_DeleteValid := (parLoop number_of_trials prop_DeleteValid).
...
Definition test_prop_UnionValid := (parLoop number_of_trials prop_UnionValid).
...
Definition test_prop_InsertPost := (parLoop number_of_trials prop_InsertPost).
...
Definition test_prop_DeletePost := (parLoop number_of_trials prop_DeletePost).
...
Definition test_prop_UnionPost := (parLoop number_of_trials prop_UnionPost).
...
Definition test_prop_InsertModel := (parLoop number_of_trials prop_InsertModel).
...
Definition test_prop_DeleteModel := (parLoop number_of_trials prop_DeleteModel).
...
Definition test_prop_UnionModel := (parLoop number_of_trials prop_UnionModel).
...
Definition test_prop_InsertInsert := (parLoop number_of_trials prop_InsertInsert).
...
Definition test_prop_InsertDelete := (parLoop number_of_trials prop_InsertDelete).
...
Definition test_prop_InsertUnion := (parLoop number_of_trials prop_InsertUnion).
...
Definition test_prop_DeleteInsert := (parLoop number_of_trials prop_DeleteInsert).
...
Definition test_prop_DeleteDelete := (parLoop number_of_trials prop_DeleteDelete).
...
Definition test_prop_DeleteUnion := (parLoop number_of_trials prop_DeleteUnion).
...
Definition test_prop_UnionDeleteInsert := (parLoop number_of_trials prop_UnionDeleteInsert).
...
Definition test_prop_UnionUnionIdem := (parLoop number_of_trials prop_UnionUnionIdem).
...
Definition test_prop_UnionUnionAssoc := (parLoop number_of_trials prop_UnionUnionAssoc).
