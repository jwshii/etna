...
Definition prop_InsertValid   :=
	ForAllMaybe "t" (fun _ => spec_derived) (fun _ t => spec_derived) (fun _ => shrink) (fun _ => show) (
...
Definition prop_UnionValid :=
	ForAllMaybe "t1" (fun _ => spec_derived) (fun _ t => spec_derived) (fun _ => shrink) (fun _ => show) (
	Implies (Tree · ∅) (fun '(t1, _) => isBST t1) (
	ForAllMaybe "t2" (fun _ => spec_derived) (fun _ n => spec_derived) (fun _ => shrink) (fun _ => show) (
...
Definition prop_UnionUnionAssoc :=
	ForAllMaybe "t1" (fun _ => spec_derived) (fun _ t1 => spec_derived) (fun _ => shrink) (fun _ => show) (
	Implies (Tree · ∅) (fun '(t1, _) => isBST t1) (
	ForAllMaybe "t2" (fun _ => spec_derived) (fun _ t2 => spec_derived) (fun _ => shrink) (fun _ => show) (
	Implies (Tree · _) (fun '(t2, _) => isBST t2) (
	ForAllMaybe "t3" (fun _ => spec_derived) (fun _ t3 => spec_derived) (fun _ => shrink) (fun _ => show) (
