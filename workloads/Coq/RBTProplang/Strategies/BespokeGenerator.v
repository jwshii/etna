...
Definition prop_InsertValid :=
	ForAll "t" (fun _ => bespoke) (fun _ t => bespoke) (fun _ => shrink) (fun _ => show) (
	Implies (Tree · ∅) (fun '(t, _) => isRBT t) (
	ForAll "k" (fun _ => genZ) (fun _ k => genZ) (fun _ => shrink) (fun _ => show) (
...
Definition prop_DeleteValid :=
	ForAll "t" (fun _ => bespoke) (fun _ t => bespoke) (fun _ => shrink) (fun _ => show) (
	Implies (Tree · ∅) (fun '(t, _) => isRBT t) (
	ForAll "k" (fun _ => genZ) (fun _ n => genZ) (fun _ => shrink) (fun _ => show) (
	Check (Z · (Tree · ∅))
...
Definition prop_DeletePost :=
	ForAll "t" (fun _ => bespoke) (fun _ t => bespoke) (fun _ => shrink) (fun _ => show) (
	Implies (Tree · ∅) (fun '(t, _) => isRBT t) (
	ForAll "k" (fun _ => genZ) (fun _ t => genZ) (fun _ => shrink) (fun _ => show) (
	ForAll "k'" (fun _ => genZ) (fun _ n => genZ) (fun _ => shrink) (fun _ => show) (
	Check (Z · (Z · (Tree · ∅)))
